...
import { useHandleDeleteFromDB } from "../hooks/useCmm/useHandleDeleteCmm";
...
export const DeleteCmmCard = () => {
  ...
  const getFullCode = () => {
    ...
    // Eğer CMM- ile başlamıyorsa ekle
  ...
  return (
    <Card className="p-4 w-full max-w-md">
      ...
      <Button
        ...
        onClick={() =>
          handleDeleteFromDB(getFullCode(), currentUser, setCurrentCode)
        }
